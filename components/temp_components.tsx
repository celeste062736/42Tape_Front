...
import { CategoryScale, Chart, PointElement, LinearScale, RadialLinearScale, LineElement } from 'chart.js';
  ...
  return (
    <div className="profile">
      <div className="centered-container">
        <img id="intra_picture" src={userInfo.intra_picture} alt="intra picture" className="rounded-circle"/>
    ...
    datasets: [
      {
        ...
        data: [userInfo.stat1, userInfo.stat2, userInfo.stat3, userInfo.stat4, userInfo.stat5],
        fill: true,
    ...
    datasets: [
      {
        ...
        data: userInfo.rankHistory,  // Use rankHistory from userInfo here
        fill: false,
      ...
      <div className="col">
        <div className="row">
          <div className="col-xl-5 d-flex justify-content-center align-items-center">
            <Profile userInfo={_userInfo}></Profile>
          </div>
          <div className="col-xl-5 d-flex justify-content-center align-items-center">
            <RadarChart userInfo={_userInfo}></RadarChart>
          </div>
          <Blank name="main"></Blank>
        </div>
        <div className="row">
          <div className="col-xl-10 d-flex justify-content-center align-items-center">
            <LineChart userInfo={_userInfo}></LineChart>
          </div>
          <Blank name="main"></Blank>
        </div>
        <div className="row">
  ...
  return (
    <div className="row">
      ...
      <div id="login_button_align" className="col">
          <Link href={`/home/${user_info}`}><button id="login_button" className="btn btn-secondary">Login</button></Link>
      </div>
      <div className="col"></div>
    </div>
  )
