...
export type RankItemProps = {
  ...
  export function Rank({ userDetails }: {userDetails: RankInfo}) {
    ...
    if (userDetails.rank === 1) {
      content =
      <div className="card_123" id="card_1st" onClick={()=>{
      ...
      content = 
      <div className="card_123" id="card_2nd_3rd" onClick={()=>{
        router.push(`/users/${userDetails.user_id}`)
      }} style={{cursor: 'pointer'}}>
        <div className="centered-container">
          ...
          <Image className="rank_picture_2_3 rounded-circle" src={userDetails.intra_picture} width={500} height={500} alt="intra picture"/>
          <div>
            <p>{userDetails.intra_id}</p>
          </div>
        </div>
      ...
      content =
      <div className="card_4" id="card_4th" onClick={()=>{
        router.push(`/users/${userDetails.user_id}`)
      }} style={{cursor: 'pointer'}}>
        <div className="left-section">
          <Image className="rank_picture_4 rounded-circle" src={userDetails.intra_picture} width={500} height={500} alt="intra picture" />
      ...
      <div className="col">
              ...
              {showSeasonInfo && (
                <div 
                  style={{
                    ...
                    display: 'inline-block',  // 여기도 inline-block을 추가
                    marginLeft: '10px'  // 옵셔널: 좌우 간격을 추가
                  }}
                >
        ...
        <div className="row">
          {currentItems.map((rank, index) => (
            <div key={index} className="col-xl-10 d-flex justify-content-center align-items-center">
