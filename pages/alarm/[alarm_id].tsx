...
// import type { UserInfo_NotiInfo } from '..';

// async function alarm(url : string, user_id: string) {
...
// export default function alarm_id_page(props: { userInfo_NotiInfo: UserInfo_NotiInfo }) {
//     alarm(process.env.FETCH_URL+'notification', props.userInfo_NotiInfo.NotiInfo.user_sub);
